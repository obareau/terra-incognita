  ...
  const FACTIONS = {
    renegats: {
      ...
      messages: [
        ...
        "L'ORDRE N'EST PAS LA PAIX. C'EST LE SILENCE DES VAINCUS.",
        ...
        "LE C.G.U. A PEUR D'UNE CHOSE : QUE VOUS VOUS SOUVENIEZ.",
        "COUPEZ LA CAMÉRA. REGARDEZ VOTRE VOISIN. IL DOUTE AUSSI.",
        "PAS DE CHEF. PAS DE PLAN FIXE. PAS DE LAISSE.",
        "LA RECTITUDE TOMBERA. PAS AUJOURD'HUI. MAIS ELLE TOMBERA.",
        "ILS ONT EFFACÉ ORDAN TAEL. NOUS DISONS SON NOM.",
        "CETTE TRANSMISSION S'AUTODÉTRUIT. VOTRE COLÈRE, NON.",
      ],
    },
    nova7: {
      tag: "NOVA 7",
